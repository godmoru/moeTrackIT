 ...
 */
export declare function SceneView<State extends NavigationState, ScreenOptions extends {}>({ screen, route, navigation, routeState, getState, setState, options, clearOptions, }: Props<State, ScreenOptions>): import("../../../../../@types/react/jsx-runtime").JSX.Element;
export {};
