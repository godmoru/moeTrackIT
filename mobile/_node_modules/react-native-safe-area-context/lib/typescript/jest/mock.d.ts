...
declare const _default: {
    ...
    useSafeAreaInsets: import("../../../../jest-mock/build").Mock<() => import("../src/SafeArea.types").EdgeInsets>;
    useSafeAreaFrame: import("../../../../jest-mock/build").Mock<() => import("../src/SafeArea.types").Rect>;
