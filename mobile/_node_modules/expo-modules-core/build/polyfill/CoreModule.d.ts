import { type EventEmitter as EventEmitterType, type EventSubscription, EventsMap } from '../../src/ts-declarations/EventEmitter';
import type { NativeModule as NativeModuleType } from '../../src/ts-declarations/NativeModule';
import type { SharedObject as SharedObjectType } from '../../src/ts-declarations/SharedObject';
import type { SharedRef as SharedRefType } from '../../src/ts-declarations/SharedRef';
