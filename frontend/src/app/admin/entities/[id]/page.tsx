...
export default function EntityProfilePage() {
    ...
    const canEdit = hasRole(['super_admin', 'system_admin', 'officer', 'principal']);
        ...
        <div className="space-y-4">
            <div className="flex flex-wrap items-center justify-between gap-3">
                ...
                <div className="flex flex-wrap items-center gap-2 text-xs">
                    {entity && (
                        <span
                            className={`inline-flex items-center rounded-full px-2.5 py-1 text-[11px] font-medium capitalize ${entity.status === "active"
                    ...
                    {canEdit && (
                        <Link
                            href={`/admin/institutions/${id}/edit`}
                            className="rounded-md bg-blue-100 px-3 py-1 font-medium text-blue-700 hover:bg-blue-200"
                        >
                            Edit
                        </Link>
                    )}
                ...
                <div className="space-y-4">
                    <div className="flex gap-2 border-b border-gray-200 text-xs">
                        ...
                        <button
                            ...
                            className={`border-b-2 px-3 py-2 font-medium ${activeTab === "assessments"
                                ? "border-green-700 text-green-700"
                                : "border-transparent text-gray-500 hover:text-gray-700"
                                }`}
                        >
